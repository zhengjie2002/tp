...
public class InvalidAddCommandException extends InvalidCommandException {
    ...
    private static final String CORRECT_FORMAT_MESSAGE = "The correct format for an add command is";
    private static final String EXAMPLE_COMMAND =
            "add --category CATEGORY --title TITLE --info INFO --date DATE [--victim VICTIM] [--officer OFFICER]";
